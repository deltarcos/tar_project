...
public class AppointmentsController {
    ...
    @PostMapping("/appointments/{patient_id}/{doctorProfile_id}/{room_id}/{duration_id}/{appmDate}/{detail}")
    ...
    DoctorProfile createdBy = doctorProfileRepository.findById(doctorProfile_id);
